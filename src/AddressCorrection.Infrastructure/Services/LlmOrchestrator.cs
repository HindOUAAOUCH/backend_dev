...
/// <summary>
/// Orchestrateur LLM avec fallback multi-modèles.
/// Responsabilité unique : tenter les modèles dans l'ordre de priorité
/// et retourner le premier résultat valide, ou (null, null) si tous échouent.
/// </summary>
